...
public class MiniJSON
{
    ...
    public static string JsonEncode(object json)
    {
        ...
        bool success = MiniJSON.SerializeValue(json, builder);
    ...
    protected object ParseNumber(char[] json, ref int index)
    {
        ...
        // 如果是 long 格式, 并且大于 0x7fffffff, 则视为 long. 否则作为 double
        long x;
        var str = new string(numberCharArray);
        if (long.TryParse(str, out x))
        {
            if (x > 0xffffffffL) return x;
            if (x < 0x7fffffffL) return (int)x;
        }
    ...
    public static bool SerializeValue(object value, StringBuilder builder)
    {
        ...
        // UEDebug.Log("type: " + t.ToString() + " isArray: " + t.IsArray);
    ...
    //public static void SerializeNumber(long number, StringBuilder builder)
    //{
